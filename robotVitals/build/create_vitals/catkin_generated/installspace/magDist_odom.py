...
class magDistOdom_maker:
	def __init__(self):
		...
		self.magDistRoc_callback = rospy.Timer(rospy.Duration(1.0), self.magDist_callback)
		self.odomPosErr_callback = rospy.Timer(rospy.Duration(1.0), self.odomPosErr_callback)
