...
LaserNoise()
{
	...
	private_nh.param("x_max", x_max_, 9.18);
	private_nh.param("x_min", x_min_, -9.18);
	private_nh.param("y_max", y_max_, 12.34);
	private_nh.param("y_min", y_min_, -8.9);
...
{	
	ROS_INFO("msg->pose.pose.position.x is %f \n", msg->pose.pose.position.x);
	ROS_INFO("msg->pose.pose.position.y is %f \n", msg->pose.pose.position.y);
